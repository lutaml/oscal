...
digraph {
  rankdir=LR
  MetaschemaXML -> ModelGenerator [label="parse"]
  ModelGenerator -> RubySourceEmitter [label="emit"]
  RubySourceEmitter -> AllModels [label="all_models.rb"]
  AllModels -> Runtime [label="require"]
  Runtime -> XML [label="from_xml / to_xml"]
  Runtime -> JSON [label="from_json / to_json"]
  Runtime -> YAML [label="from_yaml / to_yaml"]
}
----
