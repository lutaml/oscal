...
module Oscal::V1_2_1
  ...
  class MetadataTitle < Base
    ...
    def self.of_json(doc, options = {})
      return super if doc.is_a?(Hash) || doc.is_a?(Array)

      new(content: [doc])
    end

    def self.from_json(data, options = {})
      return super if data.is_a?(Hash) || data.is_a?(Array)
  ...
  class MetadataRevision < Base
    ...
    key_value do
      map "published", to: :published,
                       with: { to: :json_to_published_published, from: :json_from_published_published }
      map "last-modified", to: :last_modified,
                           with: { to: :json_to_last_modified_last_modified, from: :json_from_last_modified_last_modified }
      map "version", to: :version,
                     with: { to: :json_to_version_version, from: :json_from_version_version }
      map "oscal-version", to: :oscal_version,
                           with: { to: :json_to_oscal_version_oscal_version, from: :json_from_oscal_version_oscal_version }
      map "remarks", to: :remarks,
                     with: { to: :json_to_remarks_remarks, from: :json_from_remarks_remarks }
    ...
    def validate_occurrences
      Metaschema::ConstraintValidator.validate_occurrences(self,
                                                           self.class.instance_variable_get(:@occurrence_constraints))
    end
  end
  ...
  class MetadataLocation < Base
    ...
    key_value do
      map "uuid", to: :uuid
      map "email-addresses", to: :email_address,
                             with: { to: :json_to_email_address_email_addresses, from: :json_from_email_address_email_addresses }
  ...
  class MetadataParty < Base
    ...
    key_value do
      ...
      map "member-of-organization", to: :member_of_organization,
                                    render_empty: true
      map "location-uuids", to: :location_uuid,
                            with: { to: :json_to_location_uuid_location_uuids, from: :json_from_location_uuid_location_uuids }
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "addresses", to: :address,
                       with: { to: :json_to_asm_address_addresses }
    end
  ...
  class BackMatterResource < Base
    ...
    key_value do
      ...
      map "citation", to: :citation,
                      with: { to: :json_to_asm_citation_citation }
 ...
 item.respond_to?(:content) ? item.content : item
  ...
  class MergeCustom < Base
    ...
    key_value do
      ...
      map "insert-controls", to: :insert_controls,
                             with: { to: :json_to_asm_insert_controls_insert_controls }
    end
  ...
  class ModifySetParameter < Base
    ...
    key_value do
      ...
      map "values", to: :parameter_value,
                    with: { to: :json_to_parameter_value_values, from: :json_from_parameter_value_values }
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "constraints", to: :parameter_constraint,
                         with: { to: :json_to_asm_parameter_constraint_constraints }
      map "guidelines", to: :parameter_guideline,
                        with: { to: :json_to_asm_parameter_guideline_guidelines }
      map "select", to: :parameter_selection,
                    with: { to: :json_to_asm_parameter_selection_select }
    end
 ...
 item.respond_to?(:content) ? item.content : item
  ...
  class InventoryItemImplementedComponent < Base
    ...
    key_value do
      ...
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "responsible-parties", to: :responsible_party,
                                 with: { to: :json_to_asm_responsible_party_responsible_parties }
    end
  ...
  class SystemImplementationLeveragedAuthorization < Base
    ...
    key_value do
      map "uuid", to: :uuid
      map "date-authorized", to: :date_authorized,
                             with: { to: :json_to_date_authorized_date_authorized, from: :json_from_date_authorized_date_authorized }
      map "remarks", to: :remarks,
                     with: { to: :json_to_remarks_remarks, from: :json_from_remarks_remarks }
      map "title", to: :title, render_empty: true
  ...
  class SystemInformationInformationType < Base
    ...
    key_value do
      ...
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "confidentiality-impact", to: :impact,
                                    with: { to: :json_to_asm_impact_confidentiality_impact }
      map "integrity-impact", to: :impact,
                              with: { to: :json_to_asm_impact_integrity_impact }
      map "availability-impact", to: :impact,
                                 with: { to: :json_to_asm_impact_availability_impact }
      map "categorizations", to: :categorization,
                             with: { to: :json_to_asm_categorization_categorizations }
    end

    def json_to_asm_categorization_categorizations(instance, doc)
      current = instance.instance_variable_get(:@categorization)
      if current.is_a?(Array)
        doc["categorizations"] = current.map { |item|
 item.respond_to?(:content) ? item.content : item
}
      elsif current
        doc["categorizations"] =
  ...
  class ByComponentExport < Base
    ...
    key_value do
      ...
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "provided", to: :provided,
                      with: { to: :json_to_asm_provided_provided }
      map "responsibilities", to: :responsibility,
                              with: { to: :json_to_asm_responsibility_responsibilities }
    end
 ...
 item.respond_to?(:content) ? item.content : item
    ...
    def json_to_asm_responsibility_responsibilities(instance, doc)
      ...
      if current.is_a?(Array)
        doc["responsibilities"] = current.map { |item|
 item.respond_to?(:content) ? item.content : item
}
      elsif current
  ...
  class ByComponentInherited < Base
    ...
    key_value do
      ...
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "responsible-roles", to: :responsible_role,
                               with: { to: :json_to_asm_responsible_role_responsible_roles }
    end
  ...
  class ActivityStep < Base
    ...
    key_value do
      ...
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "reviewed-controls", to: :reviewed_controls,
                               with: { to: :json_to_asm_reviewed_controls_reviewed_controls }
      map "responsible-roles", to: :responsible_role,
                               with: { to: :json_to_asm_responsible_role_responsible_roles }
    end
  ...
  class ReviewedControlsControlSelection < Base
    ...
    key_value do
      ...
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "exclude-controls", to: :select_control_by_id,
                              with: { to: :json_to_asm_select_control_by_id_exclude_controls }
      map "include-all", to: :include_all,
                         with: { to: :json_to_asm_include_all_include_all }
      map "include-controls", to: :select_control_by_id,
                              with: { to: :json_to_asm_select_control_by_id_include_controls }
    end
  ...
  class ReviewedControlsControlObjectiveSelection < Base
    ...
    key_value do
      ...
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "exclude-objectives", to: :select_objective_by_id,
                                with: { to: :json_to_asm_select_objective_by_id_exclude_objectives }
      map "include-all", to: :include_all,
                         with: { to: :json_to_asm_include_all_include_all }
      map "include-objectives", to: :select_objective_by_id,
                                with: { to: :json_to_asm_select_objective_by_id_include_objectives }
    end
  ...
  class TaskTiming < Base
    ...
    key_value do
      ...
      map "within-date-range", to: :within_date_range,
                               with: { to: :json_to_asm_within_date_range_within_date_range }
      map "at-frequency", to: :at_frequency,
                          with: { to: :json_to_asm_at_frequency_at_frequency }
    end

    def json_to_asm_at_frequency_at_frequency(instance, doc)
      current = instance.instance_variable_get(:@at_frequency)
      if current.is_a?(Array)
        doc["at-frequency"] = current.map { |item|
 item.respond_to?(:content) ? item.content : item
}
      elsif current
        doc["at-frequency"] =
 ...
 item.respond_to?(:content) ? item.content : item
    ...
    def json_to_asm_within_date_range_within_date_range(instance, doc)
      ...
      if current.is_a?(Array)
        doc["within-date-range"] = current.map { |item|
 item.respond_to?(:content) ? item.content : item
}
      elsif current
  ...
  class TaskAssociatedActivity < Base
    ...
    key_value do
      ...
      map "responsible-roles", to: :responsible_role,
                               with: { to: :json_to_asm_responsible_role_responsible_roles }
      map "subjects", to: :assessment_subject,
                      with: { to: :json_to_asm_assessment_subject_subjects }
    end
  ...
  class AssessmentAssetsAssessmentPlatform < Base
    ...
    key_value do
      ...
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "uses-components", to: :uses_component,
                             with: { to: :json_to_asm_uses_component_uses_components }
    end
    ...
    def json_to_asm_uses_component_uses_components(instance, doc)
      ...
      if current.is_a?(Array)
        doc["uses-components"] = current.map { |item|
 item.respond_to?(:content) ? item.content : item
}
      elsif current
        doc["uses-components"] =
  ...
  class RiskMitigatingFactor < Base
    ...
    key_value do
      ...
      map "props", to: :property, with: { to: :json_to_asm_property_props }
      map "links", to: :link, with: { to: :json_to_asm_link_links }
      map "subjects", to: :subject_reference,
                      with: { to: :json_to_asm_subject_reference_subjects }
    end
 ...
 item.respond_to?(:content) ? item.content : item
  ...
  class AssessmentPlanLocalDefinitions < Base
    ...
    key_value do
      map "remarks", to: :remarks,
                     with: { to: :json_to_remarks_remarks, from: :json_from_remarks_remarks }
      map "components", to: :system_component,
                        with: { to: :json_to_asm_system_component_components }
      map "inventory-items", to: :inventory_item,
                             with: { to: :json_to_asm_inventory_item_inventory_items }
      map "users", to: :system_user,
                   with: { to: :json_to_asm_system_user_users }
      map "objectives-and-methods", to: :local_objective,
                                    with: { to: :json_to_asm_local_objective_objectives_and_methods }
      map "activities", to: :activity,
                        with: { to: :json_to_asm_activity_activities }
    end
  ...
  class AssessmentPlanTermsAndConditions < Base
    ...
    key_value do
      map "parts", to: :assessment_part,
                   with: { to: :json_to_asm_assessment_part_parts }
    end
  ...
  class ResultLocalDefinitions < Base
    ...
    key_value do
      ...
      map "users", to: :system_user,
                   with: { to: :json_to_asm_system_user_users }
      map "assessment-assets", to: :assessment_assets,
                               with: { to: :json_to_asm_assessment_assets_assessment_assets }
 ...
 item.respond_to?(:content) ? item.content : item
  ...
  class PoamItemOrigin < Base
    ...
    key_value do
      map "actors", to: :origin_actor,
                    with: { to: :json_to_asm_origin_actor_actors }
    end
  ...
  class Metadata < Base
    ...
    key_value do
      ...
      map "document-ids", to: :document_id,
                          with: { to: :json_soa_to_document_id_document_ids, from: :json_soa_from_document_id_document_ids }
      map "document-id", to: :document_id,
                         with: { to: :json_soa_to_document_id_document_ids, from: :json_soa_from_document_id_document_ids }
    end
  ...
  class ResponsibleParty < Base
    ...
    key_value do
      ...
      map "party-uuids", to: :party_uuid,
                         with: { to: :json_to_party_uuid_party_uuids, from: :json_from_party_uuid_party_uuids }
      map "remarks", to: :remarks,
                     with: { to: :json_to_remarks_remarks, from: :json_from_remarks_remarks }
      map "props", to: :property, render_empty: true
      map "links", to: :link, render_empty: true
  ...
  class Address < Base
    ...
    key_value do
      ...
      map "addr-lines", to: :addr_line,
                        with: { to: :json_to_addr_line_addr_lines, from: :json_from_addr_line_addr_lines }
  ...
  class Parameter < Base
    ...
    key_value do
      ...
      map "select", to: :parameter_selection,
                    with: { to: :json_assembly_soa_to_parameter_selection_select, from: :json_assembly_soa_from_parameter_selection_select }
    end
  ...
  class ParameterSelection < Base
    ...
    key_value do
      ...
      map "choice", to: :choice,
                    with: { to: :json_soa_to_choice_choice, from: :json_soa_from_choice_choice }
    end
  ...
  class SelectControlById < Base
    ...
    key_value do
      ...
      map "with-ids", to: :with_id,
                      with: { to: :json_to_with_id_with_ids, from: :json_from_with_id_with_ids }
  ...
  class Catalog < Base
    ...
    key_value do
      ...
      map "metadata", to: :metadata,
                      with: { to: :json_assembly_soa_to_metadata_metadata, from: :json_assembly_soa_from_metadata_metadata }
      map "back-matter", to: :back_matter,
                         with: { to: :json_assembly_soa_to_back_matter_back_matter, from: :json_assembly_soa_from_back_matter_back_matter }
    end
  ...
  class Mapping < Base
    ...
    key_value do
      ...
      map "remarks", to: :remarks,
                     with: { to: :json_to_remarks_remarks, from: :json_from_remarks_remarks }
      map "mapping-description", to: :mapping_description,
                                 with: { to: :json_to_mapping_description_mapping_description, from: :json_from_mapping_description_mapping_description }
      map "coverage", to: :coverage,
                      with: { to: :json_to_coverage_coverage, from: :json_from_coverage_coverage }
      map "maps", to: :map, render_empty: true
      map "props", to: :property, render_empty: true
      map "links", to: :link, render_empty: true
      map "source-resource", to: :mapping_resource_reference,
                             with: { to: :json_assembly_soa_to_mapping_resource_reference_source_resource, from: :json_assembly_soa_from_mapping_resource_reference_source_resource }
      map "target-resource", to: :mapping_resource_reference,
                             with: { to: :json_assembly_soa_to_mapping_resource_reference_target_resource, from: :json_assembly_soa_from_mapping_resource_reference_target_resource }
      map "source-gap-summary", to: :gap_summary,
                                with: { to: :json_assembly_soa_to_gap_summary_source_gap_summary, from: :json_assembly_soa_from_gap_summary_source_gap_summary }
      map "target-gap-summary", to: :gap_summary,
                                with: { to: :json_assembly_soa_to_gap_summary_target_gap_summary, from: :json_assembly_soa_from_gap_summary_target_gap_summary }
      map "confidence-score", to: :confidence_score,
                              with: { to: :json_assembly_soa_to_confidence_score_confidence_score, from: :json_assembly_soa_from_confidence_score_confidence_score }
    end

    def json_assembly_soa_from_confidence_score_confidence_score(instance,
value)
      items = case value
              when Hash then [value]
              when Array then value
    ...
    def json_assembly_soa_from_mapping_resource_reference_source_resource(
      instance, value
)
      items = case value
              when Hash then [value]
    ...
    def json_assembly_soa_to_mapping_resource_reference_source_resource(
      instance, doc
)
    ...
    def json_assembly_soa_from_mapping_resource_reference_target_resource(
      instance, value
)
      items = case value
              when Hash then [value]
    ...
    def json_assembly_soa_to_mapping_resource_reference_target_resource(
      instance, doc
)
      current = instance.instance_variable_get(:@mapping_resource_reference)
      return if current.nil?
  ...
  class Map < Base
    ...
    key_value do
      ...
      map "relationship", to: :relationship,
                          with: { to: :json_soa_to_relationship_relationship, from: :json_soa_from_relationship_relationship }
      map "confidence-score", to: :confidence_score,
                              with: { to: :json_assembly_soa_to_confidence_score_confidence_score, from: :json_assembly_soa_from_confidence_score_confidence_score }
    end
  ...
  class ConfidenceScore < Base
    ...
    key_value do
      map "percentage", to: :percentage,
                        with: { to: :json_to_percentage_percentage, from: :json_from_percentage_percentage }
...
value)
  ...
  class MappingCollection < Base
    ...
    key_value do
      ...
      map "metadata", to: :metadata,
                      with: { to: :json_assembly_soa_to_metadata_metadata, from: :json_assembly_soa_from_metadata_metadata }
      map "provenance", to: :mapping_provenance,
                        with: { to: :json_assembly_soa_to_mapping_provenance_provenance, from: :json_assembly_soa_from_mapping_provenance_provenance }
      map "mappings", to: :mapping,
                      with: { to: :json_assembly_soa_to_mapping_mappings, from: :json_assembly_soa_from_mapping_mappings }
      map "back-matter", to: :back_matter,
                         with: { to: :json_assembly_soa_to_back_matter_back_matter, from: :json_assembly_soa_from_back_matter_back_matter }
    end
  ...
  class Profile < Base
    ...
    key_value do
      ...
      map "metadata", to: :metadata,
                      with: { to: :json_assembly_soa_to_metadata_metadata, from: :json_assembly_soa_from_metadata_metadata }
      map "merge", to: :merge,
                   with: { to: :json_assembly_soa_to_merge_merge, from: :json_assembly_soa_from_merge_merge }
      map "modify", to: :modify,
                    with: { to: :json_assembly_soa_to_modify_modify, from: :json_assembly_soa_from_modify_modify }
      map "back-matter", to: :back_matter,
                         with: { to: :json_assembly_soa_to_back_matter_back_matter, from: :json_assembly_soa_from_back_matter_back_matter }
    end
  ...
  class Import < Base
    ...
    key_value do
      ...
      map "include-all", to: :include_all,
                         with: { to: :json_assembly_soa_to_include_all_include_all, from: :json_assembly_soa_from_include_all_include_all }
    end
  ...
  class Merge < Base
    ...
    key_value do
      ...
      map "combine", to: :combine,
                     with: { to: :json_assembly_soa_to_combine_combine, from: :json_assembly_soa_from_combine_combine }
      map "flat", to: :flat,
                  with: { to: :json_assembly_soa_to_flat_flat, from: :json_assembly_soa_from_flat_flat }
      map "custom", to: :custom,
                    with: { to: :json_assembly_soa_to_custom_custom, from: :json_assembly_soa_from_custom_custom }
    end
  ...
  class SystemComponent < Base
    ...
    key_value do
      ...
      map "status", to: :status,
                    with: { to: :json_assembly_soa_to_status_status, from: :json_assembly_soa_from_status_status }
    end
  ...
  class SystemUser < Base
    ...
    key_value do
      map "uuid", to: :uuid
      map "role-ids", to: :role_id,
                      with: { to: :json_to_role_id_role_ids, from: :json_from_role_id_role_ids }
      map "remarks", to: :remarks,
                     with: { to: :json_to_remarks_remarks, from: :json_from_remarks_remarks }
      map "title", to: :title, render_empty: true
      map "short-name", to: :short_name, render_empty: true
  ...
  class AuthorizedPrivilege < Base
    ...
    key_value do
      map "functions-performed", to: :function_performed,
                                 with: { to: :json_to_function_performed_functions_performed, from: :json_from_function_performed_functions_performed }
      map "title", to: :title, render_empty: true
      map "description", to: :description, render_empty: true
    end
  ...
  class InventoryItem < Base
    ...
    attribute :implemented_component, :inventory_item_implemented_component,
              collection: true
    ...
    key_value do
      ...
      map "links", to: :link, render_empty: true
      map "responsible-parties", to: :responsible_party, render_empty: true
      map "implemented-components", to: :implemented_component,
                                    render_empty: true
    end
  ...
  class ComponentDefinition < Base
    attribute :uuid, :string
    attribute :metadata, :metadata
    attribute :import_component_definition, :import_component_definition,
              collection: true
    ...
    xml do
      ...
      map_attribute "uuid", to: :uuid
      map_element "metadata", to: :metadata
      map_element "import-component-definition",
                  to: :import_component_definition
    ...
    key_value do
      map "uuid", to: :uuid
      map "import-component-definitions", to: :import_component_definition,
                                          render_empty: true
  ...
  class DefinedComponent < Base
    ...
    key_value do
      ...
      map "responsible-roles", to: :responsible_role, render_empty: true
      map "protocols", to: :protocol, render_empty: true
      map "control-implementations", to: :control_implementation,
                                     render_empty: true
    end
  ...
  class Capability < Base
    ...
    key_value do
      ...
      map "props", to: :property, render_empty: true
      map "links", to: :link, render_empty: true
      map "incorporates-components", to: :incorporates_component,
                                     render_empty: true
      map "control-implementations", to: :control_implementation,
                                     render_empty: true
    end
  ...
  class ControlImplementation < Base
    ...
    attribute :implemented_requirement, :implemented_requirement,
              collection: true
    ...
    key_value do
      ...
      map "links", to: :link, render_empty: true
      map "set-parameters", to: :set_parameter, render_empty: true
      map "implemented-requirements", to: :implemented_requirement,
                                      render_empty: true
    end
  ...
  class SystemSecurityPlan < Base
    ...
    key_value do
      ...
      map "metadata", to: :metadata,
                      with: { to: :json_assembly_soa_to_metadata_metadata, from: :json_assembly_soa_from_metadata_metadata }
      map "import-profile", to: :import_profile,
                            with: { to: :json_assembly_soa_to_import_profile_import_profile, from: :json_assembly_soa_from_import_profile_import_profile }
      map "system-characteristics", to: :system_characteristics,
                                    with: { to: :json_assembly_soa_to_system_characteristics_system_characteristics, from: :json_assembly_soa_from_system_characteristics_system_characteristics }
      map "system-implementation", to: :system_implementation,
                                   with: { to: :json_assembly_soa_to_system_implementation_system_implementation, from: :json_assembly_soa_from_system_implementation_system_implementation }
      map "control-implementation", to: :control_implementation,
                                    with: { to: :json_assembly_soa_to_control_implementation_control_implementation, from: :json_assembly_soa_from_control_implementation_control_implementation }
      map "back-matter", to: :back_matter,
                         with: { to: :json_assembly_soa_to_back_matter_back_matter, from: :json_assembly_soa_from_back_matter_back_matter }
    end
    ...
    def json_assembly_soa_from_control_implementation_control_implementation(
      instance, value
)
      items = case value
              when Hash then [value]
    ...
    def json_assembly_soa_to_control_implementation_control_implementation(
      instance, doc
)
    ...
    def json_assembly_soa_from_system_characteristics_system_characteristics(
      instance, value
)
      items = case value
              when Hash then [value]
    ...
    def json_assembly_soa_to_system_characteristics_system_characteristics(
      instance, doc
)
    ...
    def json_assembly_soa_from_system_implementation_system_implementation(
      instance, value
)
      items = case value
              when Hash then [value]
    ...
    def json_assembly_soa_to_system_implementation_system_implementation(
      instance, doc
)
  ...
  class SystemCharacteristics < Base
    ...
    key_value do
      ...
      map "description", to: :description, render_empty: true
      map "security-sensitivity-level", to: :security_sensitivity_level,
                                        render_empty: true
      map "props", to: :property, render_empty: true
      map "links", to: :link, render_empty: true
      map "responsible-parties", to: :responsible_party, render_empty: true
      map "system-ids", to: :system_id,
                        with: { to: :json_soa_to_system_id_system_ids, from: :json_soa_from_system_id_system_ids }
      map "system-id", to: :system_id,
                       with: { to: :json_soa_to_system_id_system_ids, from: :json_soa_from_system_id_system_ids }
      map "system-information", to: :system_information,
                                with: { to: :json_assembly_soa_to_system_information_system_information, from: :json_assembly_soa_from_system_information_system_information }
      map "security-impact-level", to: :security_impact_level,
                                   with: { to: :json_assembly_soa_to_security_impact_level_security_impact_level, from: :json_assembly_soa_from_security_impact_level_security_impact_level }
      map "status", to: :status,
                    with: { to: :json_assembly_soa_to_status_status, from: :json_assembly_soa_from_status_status }
      map "authorization-boundary", to: :authorization_boundary,
                                    with: { to: :json_assembly_soa_to_authorization_boundary_authorization_boundary, from: :json_assembly_soa_from_authorization_boundary_authorization_boundary }
      map "network-architecture", to: :network_architecture,
                                  with: { to: :json_assembly_soa_to_network_architecture_network_architecture, from: :json_assembly_soa_from_network_architecture_network_architecture }
      map "data-flow", to: :data_flow,
                       with: { to: :json_assembly_soa_to_data_flow_data_flow, from: :json_assembly_soa_from_data_flow_data_flow }
    end

    def json_assembly_soa_from_authorization_boundary_authorization_boundary(
      instance, value
)
      items = case value
              when Hash then [value]
    ...
    def json_assembly_soa_to_authorization_boundary_authorization_boundary(
      instance, doc
)
    ...
    def json_assembly_soa_from_network_architecture_network_architecture(
      instance, value
)
      items = case value
              when Hash then [value]
    ...
    def json_assembly_soa_to_network_architecture_network_architecture(
      instance, doc
)
    ...
    def json_assembly_soa_from_security_impact_level_security_impact_level(
      instance, value
)
      items = case value
              when Hash then [value]
    ...
    def json_assembly_soa_to_security_impact_level_security_impact_level(
      instance, doc
)
    ...
    def json_assembly_soa_from_system_information_system_information(instance,
value)
      items = case value
              when Hash then [value]
              when Array then value
    ...
    def json_assembly_soa_to_system_information_system_information(instance,
doc)
  ...
  class SystemImplementation < Base
    ...
    attribute :system_component, :system_component, collection: true
    attribute :inventory_item, :inventory_item, collection: true
    attribute :leveraged_authorization,
              :system_implementation_leveraged_authorization, collection: true
    ...
    key_value do
      ...
      map "leveraged-authorizations", to: :leveraged_authorization,
                                      render_empty: true
    end
  ...
  class SystemInformation < Base
    attribute :property, :property, collection: true
    attribute :link, :link, collection: true
    attribute :information_type, :system_information_information_type,
              collection: true
  ...
  class SecurityImpactLevel < Base
    ...
    xml do
      ...
      ordered
      map_element "security-objective-confidentiality",
                  to: :security_objective_confidentiality
      map_element "security-objective-integrity",
                  to: :security_objective_integrity
      map_element "security-objective-availability",
                  to: :security_objective_availability
    end

    key_value do
      map "security-objective-confidentiality",
          to: :security_objective_confidentiality, render_empty: true
      map "security-objective-integrity", to: :security_objective_integrity,
                                          render_empty: true
      map "security-objective-availability",
          to: :security_objective_availability, render_empty: true
    end
  end
  ...
  class Impact < Base
    ...
    key_value do
      map "base", to: :base,
                  with: { to: :json_to_base_base, from: :json_from_base_base }
      map "selected", to: :selected,
                      with: { to: :json_to_selected_selected, from: :json_from_selected_selected }
      map "adjustment-justification", to: :adjustment_justification,
                                      with: { to: :json_to_adjustment_justification_adjustment_justification, from: :json_from_adjustment_justification_adjustment_justification }
      map "props", to: :property, render_empty: true
      map "links", to: :link, render_empty: true
    end

    def json_from_adjustment_justification_adjustment_justification(instance,
value)
      if value.is_a?(Array)
  ...
  class ByComponent < Base
    ...
    key_value do
      ...
      map "implementation-status", to: :implementation_status,
                                   with: { to: :json_assembly_soa_to_implementation_status_implementation_status, from: :json_assembly_soa_from_implementation_status_implementation_status }
      map "export", to: :export,
                    with: { to: :json_assembly_soa_to_export_export, from: :json_assembly_soa_from_export_export }
    end
    ...
    def json_assembly_soa_from_implementation_status_implementation_status(
      instance, value
)
      items = case value
              when Hash then [value]
    ...
    def json_assembly_soa_to_implementation_status_implementation_status(
      instance, doc
)
  ...
  class AssessmentMethod < Base
    ...
    key_value do
      ...
      map "props", to: :property, render_empty: true
      map "links", to: :link, render_empty: true
      map "assessment-part", to: :assessment_part,
                             with: { to: :json_assembly_soa_to_assessment_part_assessment_part, from: :json_assembly_soa_from_assessment_part_assessment_part }
    end
  ...
  class Activity < Base
    ...
    key_value do
      ...
      map "related-controls", to: :reviewed_controls,
                              with: { to: :json_assembly_soa_to_reviewed_controls_related_controls, from: :json_assembly_soa_from_reviewed_controls_related_controls }
    end

    def json_assembly_soa_from_reviewed_controls_related_controls(instance,
value)
      items = case value
              when Hash then [value]
              when Array then value
  ...
  class ReviewedControls < Base
    ...
    attribute :control_selection, :reviewed_controls_control_selection,
              collection: true
    attribute :control_objective_selection,
              :reviewed_controls_control_objective_selection, collection: true
    ...
    xml do
      ...
      map_element "control-objective-selection",
                  to: :control_objective_selection
    end
    ...
    key_value do
      ...
      map "control-objective-selections", to: :control_objective_selection,
                                          render_empty: true
    end
  ...
  class Task < Base
    ...
    key_value do
      ...
      map "timing", to: :timing,
                    with: { to: :json_assembly_soa_to_timing_timing, from: :json_assembly_soa_from_timing_timing }
    end
  ...
  class AssessmentAssets < Base
    attribute :system_component, :system_component, collection: true
    attribute :assessment_platform, :assessment_assets_assessment_platform,
              collection: true
  ...
  class Finding < Base
    ...
    xml do
      ...
      map_element "title", to: :title
      map_element "description", to: :description
      map_element "implementation-statement-uuid",
                  to: :implementation_statement_uuid
    end
    ...
    key_value do
      ...
      map "title", to: :title, render_empty: true
      map "description", to: :description, render_empty: true
      map "implementation-statement-uuid", to: :implementation_statement_uuid,
                                           render_empty: true
      map "props", to: :property, render_empty: true
      map "links", to: :link, render_empty: true
      ...
      map "target", to: :finding_target,
                    with: { to: :json_assembly_soa_to_finding_target_target, from: :json_assembly_soa_from_finding_target_target }
    end
  ...
  class Observation < Base
    ...
    attribute :relevant_evidence, :observation_relevant_evidence,
              collection: true
  ...
  class RelatedTask < Base
    ...
    key_value do
      ...
      map "responsible-parties", to: :responsible_party, render_empty: true
      map "subjects", to: :assessment_subject, render_empty: true
      map "identified-subject", to: :identified_subject,
                                with: { to: :json_assembly_soa_to_identified_subject_identified_subject, from: :json_assembly_soa_from_identified_subject_identified_subject }
    end

    def json_assembly_soa_from_identified_subject_identified_subject(instance,
value)
      items = case value
              when Hash then [value]
              when Array then value
    ...
    def json_assembly_soa_to_identified_subject_identified_subject(instance,
doc)
  ...
  class Risk < Base
    ...
    key_value do
      map "uuid", to: :uuid
      map "status", to: :risk_status,
                    with: { to: :json_to_risk_status_status, from: :json_from_risk_status_status }
      map "title", to: :title, render_empty: true
      map "description", to: :description, render_empty: true
      ...
      map "threat-ids", to: :threat_id,
                        with: { to: :json_soa_to_threat_id_threat_ids, from: :json_soa_from_threat_id_threat_ids }
      map "threat-id", to: :threat_id,
                       with: { to: :json_soa_to_threat_id_threat_ids, from: :json_soa_from_threat_id_threat_ids }
      map "risk-log", to: :risk_log,
                      with: { to: :json_assembly_soa_to_risk_log_risk_log, from: :json_assembly_soa_from_risk_log_risk_log }
    end
  ...
  class Characterization < Base
    ...
    key_value do
      ...
      map "origin", to: :origin,
                    with: { to: :json_assembly_soa_to_origin_origin, from: :json_assembly_soa_from_origin_origin }
    end
  ...
  class AssessmentPlan < Base
    ...
    key_value do
      ...
      map "metadata", to: :metadata,
                      with: { to: :json_assembly_soa_to_metadata_metadata, from: :json_assembly_soa_from_metadata_metadata }
      map "import-ssp", to: :import_ssp,
                        with: { to: :json_assembly_soa_to_import_ssp_import_ssp, from: :json_assembly_soa_from_import_ssp_import_ssp }
      map "reviewed-controls", to: :reviewed_controls,
                               with: { to: :json_assembly_soa_to_reviewed_controls_reviewed_controls, from: :json_assembly_soa_from_reviewed_controls_reviewed_controls }
      map "assessment-assets", to: :assessment_assets,
                               with: { to: :json_assembly_soa_to_assessment_assets_assessment_assets, from: :json_assembly_soa_from_assessment_assets_assessment_assets }
      map "back-matter", to: :back_matter,
                         with: { to: :json_assembly_soa_to_back_matter_back_matter, from: :json_assembly_soa_from_back_matter_back_matter }
      map "local-definitions", to: :local_definitions,
                               with: { to: :json_assembly_soa_to_local_definitions_local_definitions, from: :json_assembly_soa_from_local_definitions_local_definitions }
      map "terms-and-conditions", to: :terms_and_conditions,
                                  with: { to: :json_assembly_soa_to_terms_and_conditions_terms_and_conditions, from: :json_assembly_soa_from_terms_and_conditions_terms_and_conditions }
    end

    def json_assembly_soa_from_assessment_assets_assessment_assets(instance,
value)
      items = case value
              when Hash then [value]
              when Array then value
    ...
    def json_assembly_soa_from_local_definitions_local_definitions(instance,
value)
      items = case value
              when Hash then [value]
              when Array then value
    ...
    def json_assembly_soa_from_reviewed_controls_reviewed_controls(instance,
value)
      items = case value
              when Hash then [value]
              when Array then value
    ...
    def json_assembly_soa_from_terms_and_conditions_terms_and_conditions(
      instance, value
)
      items = case value
              when Hash then [value]
    ...
    def json_assembly_soa_to_terms_and_conditions_terms_and_conditions(
      instance, doc
)
  ...
  class AssessmentResults < Base
    ...
    key_value do
      ...
      map "metadata", to: :metadata,
                      with: { to: :json_assembly_soa_to_metadata_metadata, from: :json_assembly_soa_from_metadata_metadata }
      map "import-ap", to: :import_ap,
                       with: { to: :json_assembly_soa_to_import_ap_import_ap, from: :json_assembly_soa_from_import_ap_import_ap }
      map "back-matter", to: :back_matter,
                         with: { to: :json_assembly_soa_to_back_matter_back_matter, from: :json_assembly_soa_from_back_matter_back_matter }
      map "local-definitions", to: :local_definitions,
                               with: { to: :json_assembly_soa_to_local_definitions_local_definitions, from: :json_assembly_soa_from_local_definitions_local_definitions }
...
value)
  ...
  class Result < Base
    ...
    key_value do
      ...
      map "local-definitions", to: :local_definitions,
                               with: { to: :json_assembly_soa_to_local_definitions_local_definitions, from: :json_assembly_soa_from_local_definitions_local_definitions }
      map "assessment-log", to: :assessment_log,
                            with: { to: :json_assembly_soa_to_assessment_log_assessment_log, from: :json_assembly_soa_from_assessment_log_assessment_log }
    end
...
value)
  ...
  class PlanOfActionAndMilestones < Base
    ...
    key_value do
      map "uuid", to: :uuid
      map "system-id", to: :system_id,
                       with: { to: :json_to_system_id_system_id, from: :json_from_system_id_system_id }
      map "observations", to: :observation, render_empty: true
      map "risks", to: :risk, render_empty: true
      map "findings", to: :finding, render_empty: true
